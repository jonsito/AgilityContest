 ...
 */
function addPerroToGuia(index,prueba) {
	alert('TODO:<br/> Index'+index+'<br/>Asignar jornadas a la prueba'+prueba);
}
/**
...
function delJornadaFromPrueba(index,prueba) {
    ...
    $.messager.confirm('Confirm',"Borrar Jornada '"+row.ID+"' de la prueba '"+prueba+"' ¿Seguro?'",function(r){
        if (r){
