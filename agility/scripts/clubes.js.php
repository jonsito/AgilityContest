...
function format_countryFlag(val,row,idx) { return '<img src="../images/logos/'+val+'" height="30" style="padding-top:2px"/>'; }
    ...
    $.ajax({
        ...
        success: function (result) {
            if (result.errorMsg){
                ...
                // on insert, update club-ID to allow save logo and/or reload changed data
