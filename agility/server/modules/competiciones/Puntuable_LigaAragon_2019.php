...
class Puntuable_LigaAragon_2019 extends Puntuable_RFEC_2018 {
    ...
    function __construct() {
        ...
        $this->moduleRevision="20181212_1250";
    ...
    public function evalPartialCalification($m,&$perro,$puestocat) {
        ...
        $tipo=$m->Tipo;
        if (in_array($tipo,array(8,9,13,14))) { // equipos
        ...
        if ( ($puestocat[$cat]>0) && ($penal<26) ) {
            if ($puesto<=10) $pt1+= $ptsmanga[$puesto-1];
        ...
        else if ($penal>=16)	{ // Puntuan si no eliminados o NC
    ...
    public function evalFinalCalification($mangas,$resultados,&$perro,$puestocat){
        ...
        // conjunta
        $pfin="0";
        // Temporada 2018 no puntuan en conjunta si tienen alguna manga con mas de 26.00 (NC)
