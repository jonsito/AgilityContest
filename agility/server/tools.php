...
/**
 * inteface to openssl_encrypt
 * from: https://bhoover.com/using-php-openssl_encrypt-openssl_decrypt-encrypt-decrypt-data/
 * @param {string} $data data to crypt
 * @param {string} $key base64 encoded 256bit key
 */
function ac_encrypt($data,$key) {
    ...
    return base64_encode($encrypted . '::' . $iv)  . PHP_EOL;
}

/**
 * inteface to openssl_decrypt
 * from: https://bhoover.com/using-php-openssl_encrypt-openssl_decrypt-encrypt-decrypt-data/
 * @param {string} $data encrypted data
 * @param {string} $key base64 encoded 256bit key
 */
function ac_decrypt($data,$key) {
    // Remove the base64 encoding from our key
    $encryption_key = base64_decode($key);
