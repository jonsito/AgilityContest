...
class PDF extends PrintCommon {
	...
	function writeTableHeader() {
		...
		$this->Cell(25,7,_('Nombre'),0,0,'C',true);	// nombre (20,y
		$this->Cell(15,7,'Lic.',0,0,'C',true);	// licencia
		$this->Cell(10,7,'Cat./Gr.',0,0,'C',true);	// categoria/grado
		$this->Cell(35,7,_('Guía'),0,0,'C',true);	// nombreGuia
		$this->Cell(20,7,'Club',0,0,'C',true);	// nombreClub
		// manga 1
		$this->Cell(7,7,'F/T',0,0,'C',true);	// 1- Faltas+Tocados
		$this->Cell(7,7,_('Reh'),0,0,'C',true);	// 1- Rehuses
		$this->Cell(12,7,_('Tiempo'),0,0,'C',true);	// 1- Tiempo
		...
		if ($this->manga2!=null) {
			...
			$this->Cell(7,7,_('Reh'),0,0,'C',true);	// 2- Rehuses
			$this->Cell(12,7,_('Tiempo'),0,0,'C',true);	// 2- Tiempo
