...
class PrintClasificacionGeneralGames extends PrintCommon {
	...
	function setCategoryString($mode) {
	...
	function print_datosMangas() {
        ...
        switch (intval($this->jornada->Tipo_Competicion)) {
            case 1: $valid=array(0,1,2,3,4); break; // pentathlon
            case 2: $valid=array(0,1,2,3); break; // biathlon
            case 3: $valid=array(0,1); break; // games
        }
        $count=0;
        foreach ($valid as $n) {
