...
<script type="text/javascript">
        ...
        $('#jueces-datagrid').datagrid({
            ...
            columns: [[
                ...
                { field:'Nombre',		width:35, sortable:true,	title: '<?php _e('Name'); ?>',formatter:formatBold },
            	{ field:'Direccion1',	width:29,					title: '<?php _e('Address'); ?> 1' },
                { field:'Direccion2',	width:24,                   title: '<?php _e('Address'); ?> 2' },
                { field:'Pais',	        width:7, sortable:true,     align:'center',   title: '<?php _e('Country'); ?>' },
            	{ field:'Telefono',		width:20, sortable:true,	title: '<?php _e('Telephone'); ?>' },
                ...
                { field:'CPC',			width:7, sortable:true,    align: 'center', title: '<?php _e('CPC');  ?>', formatter:juecesCPC },
                { field:'Nat3',			width:7, sortable:true,    align: 'center', title: '<?php _e('Nat3'); ?>', formatter:juecesNat3 },
                { field:'Nat4',			width:7, sortable:true,    align: 'center', title: '<?php _e('Nat4'); ?>', formatter:juecesNat4 },
                { field:'Nat5',			width:7, sortable:true,    align: 'center', title: '<?php _e('Nat5'); ?>', formatter:juecesNat5 },
            	{ field:'Internacional',width:6, align:'center',	title: '<?php _e('Intl'); ?>.' 	},
            	{ field:'Practicas',	width:6, align:'center',	title: '<?php _e('Pract'); ?>.' },
            	{ field:'Email',		width:25, sortable:true,   align:'right', title: '<?php _e('Electronic mail'); ?>' },
