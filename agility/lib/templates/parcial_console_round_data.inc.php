...
<form id="resultadosmanga-trs-form" method="get">
    <table width="100%">
        ...
        <tr id="resultadosmanga-XLargeRow">
            ...
            <th id="resultadosmanga-XLargeLbl" style="width:150px">Large</th>
            ...
            <td><?php _e('SCT'); ?> <input type="text" size="4" class="easyui-textbox trstrm" readonly="readonly" id="rm_TRS_X"></td>
            <td><?php _e('MCT'); ?> <input type="text" size="4" class="easyui-textbox trstrm" readonly="readonly" id="rm_TRM_X"></td>
            <td><?php _e('Vel'); ?>. <input type="text" size="4" class="easyui-textbox trstrm" readonly="readonly" id="rm_VEL_X"></td>
        </tr>
