...
<script src="public.js.php" type="text/javascript" charset="utf-8" > </script>
...
function public_acceptSelection() {
	...
	switch (o){
	case 'inscritos':
        if (isJornadaEquipos(null) ) page="../public/pb_inscripciones_equipos.php";
        else page="../public/pb_inscripciones.php";
		break;
	case 'ordensalida':
		page="../public/pb_ordensalida.php";
		break;
	case 'entrenamientos':
			page="../public/pb_entrenamientos.php";
			break;
	case 'parciales':
        if (isJornadaEquipos(null) ) page="../public/pb_parciales_equipos.php";
        else page="../public/pb_parciales.php";
		break;
	case 'clasificaciones':
        if (isJornadaEquipos(null) ) page="../public/pb_finales_equipos.php";
        else page="../public/pb_finales.php";
        break;
    case 'programa':
        page="../public/pb_programa.php";
        break;
    }
