...
<div id="pb_footer">
    <span style="float:left">
        <a id="pb_footer-urlFederation" target="fed" href="" style="border:0 none;text-decoration:none;">
            <img id="pb_footer-logoFederation" src="../images/logos/agilitycontest.png" alt="" height="40"/>
        </a>
        <a id="pb_footer-urlFederation2" target="fed2" href="" style="text-decoration:none">
            <img id="pb_footer-logoFederation2" src="../images/logos/agilitycontest.png" alt="" height="40"/>
        </a>
...
?>
        ...
        <a target="acontest" href="https://www.github.com/jonsito/AgilityContest " style="text-decoration:none;">
            <img id="pb_footer-logoAgilityContest" src="../images/supporters/agilitycontest.png" alt="agilitycontest" height="40"/>
        </a>
        <a target="cubenode" href="http://www.cubenode.com" style="text-decoration:none;">
            <img id="pb_footer-logoAgilityContest" src="../awcfci2016/cubenode2.png" alt="cubenode" height="40"/>
        </a>
