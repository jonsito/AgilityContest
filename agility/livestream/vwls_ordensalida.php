...
$('#vw_ordensalida-datagrid').datagrid({
    ...
    columns:[[
        ...
        { field:'Logo',     	width:'5%', align:'center',	title: '',formatter: vwls_formatLogoLiveStream },
        ...
        { field:'Categoria',	width:'4%', align:'center',	title: '<?php _e('Categ'); ?>.' ,formatter:formatCategoria},
