...
header("Access-Control-Allow-Origin: https://www.facebook.com/v2.9/dialog/",false);
/*
 index.php
...
<body id="body">
<script src="/agility/lib/facebook_api.js" type="text/javascript" charset="utf-8" > </script>
<div id="pb_layout">
...
<div id="menu_panel" data-options="region:'center'">
        <h1><?php _e("Online information"); ?></h1>
            <?php _e("Init Facebook session to access special features");?>
