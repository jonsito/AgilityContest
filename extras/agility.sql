...
--
-- Servidor: localhost
-- Tiempo de generación: 10-04-2015 a las 12:01:39
...
--
-- Creación: 10-04-2015 a las 11:53:30
--
...
--
-- Creación: 10-04-2015 a las 11:53:31
--
...
INSERT INTO `equipos` (`ID`, `Prueba`, `Jornada`, `Orden`, `Categorias`, `Nombre`, `Observaciones`, `Miembros`, `DefaultTeam`) VALUES
...
--
-- Creación: 10-04-2015 a las 11:53:32
--
...
INSERT INTO `inscripciones` (`ID`, `Prueba`, `Perro`, `Dorsal`, `Celo`, `Observaciones`, `Jornadas`, `Pagado`) VALUES
(295, 2, 602, 110, 0, '', 3, 0),
(296, 2, 148, 93, 0, '', 1, 0),
(297, 2, 416, 92, 0, '', 1, 0),
(298, 2, 519, 35, 0, '', 2, 0),
...
INSERT INTO `jornadas` (`ID`, `Prueba`, `Numero`, `SlaveOf`, `Extra`, `Nombre`, `Fecha`, `Hora`, `Grado1`, `Grado2`, `Grado3`, `Open`, `Equipos3`, `Equipos4`, `PreAgility`, `KO`, `Especial`, `PreAgility2`, `Cerrada`, `Observaciones`, `Orden_Tandas`, `Orden_Equipos`) VALUES
...
--
-- Creación: 10-04-2015 a las 11:53:33
--
...
--
-- Creación: 10-04-2015 a las 11:53:34
--
...
INSERT INTO `resultados` (`Prueba`, `Jornada`, `Manga`, `Dorsal`, `Perro`, `Equipo`, `Nombre`, `Raza`, `Licencia`, `Categoria`, `Grado`, `Celo`, `NombreGuia`, `NombreClub`, `Entrada`, `Comienzo`, `Faltas`, `Rehuses`, `Tocados`, `Eliminado`, `NoPresentado`, `Tiempo`, `Observaciones`, `Pendiente`) VALUES
...
--
-- Creación: 10-04-2015 a las 11:53:35
--
...
--
ALTER TABLE `equipos`
  ADD PRIMARY KEY (`ID`), ADD UNIQUE KEY `Equipos_JornadaNombre` (`Jornada`,`Nombre`), ADD KEY `Equipos_Prueba` (`Prueba`), ADD KEY `Equipos_Jornada` (`Jornada`);
...
ALTER TABLE `inscripciones`
  ADD PRIMARY KEY (`ID`), ADD UNIQUE KEY `Inscripciones_PruebaPerro` (`Prueba`,`Perro`), ADD KEY `Inscripciones_Perro` (`Perro`), ADD KEY `Inscripciones_Prueba` (`Prueba`), ADD KEY `Inscripciones_Dorsal` (`Dorsal`);
...
ADD CONSTRAINT `Equipos_ibfk_2` FOREIGN KEY (`Jornada`) REFERENCES `jornadas` (`ID`) ON DELETE CASCADE ON UPDATE CASCADE;
