...
GRANT SELECT, INSERT, UPDATE, DELETE, CREATE TEMPORARY TABLES, LOCK TABLES, TRIGGER, EXECUTE, CREATE VIEW, SHOW VIEW, SHOW CREATE PROCEDURE EVENT ON `agility`.* TO 'agility_operator'@'localhost';
